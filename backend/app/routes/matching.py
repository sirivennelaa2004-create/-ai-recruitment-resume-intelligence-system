...
def match_resume_to_job(
    ...
    # Only a recruiter can view candidate-job matching results.
    ...
    # A recruiter can only match candidates to their own jobs.
    ...
    return {
        ...
        **result,
        "explanation": (
            ...
            f"The weighted skill-match score is "
    ...
    for application, candidate in applicants:
        ...
        if not resume:
            rankings.append({
                ...
                "explanation": "This candidate has not uploaded a resume."
            })
            continue
